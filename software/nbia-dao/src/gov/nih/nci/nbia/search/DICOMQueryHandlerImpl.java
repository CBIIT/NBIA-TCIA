...
public class DICOMQueryHandlerImpl extends AbstractDAO
    ...
    private static final String SQL_QUERY_WHERE_NEITHER = " WHERE series.visibility in ('1') ";
    private static final String SQL_QUERY_WHERE_BOTH = " WHERE series.visibility in ('1') and p.id = sn.id and p.id = nm.id ";
    private static final String SQL_QUERY_WHERE_STUDY = " WHERE series.visibility in ('1') and p.id = sn.id ";
    private static final String SQL_QUERY_WHERE_MONTH = " WHERE series.visibility in ('1') and p.id = nm.id ";
