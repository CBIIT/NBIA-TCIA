...
public class PixelSpacingRangeCriteria extends PersistentCriteria {
    private static final long serialVersionUID = 1L;
    private String from;
    private String to;
    private static Logger logger = LogManager.getLogger(PixelSpacingRangeCriteria.class);
    ...
    public void addValueFromQueryAttribute(QueryAttributeWrapper attr) {
    	...
    	try {
    		...
    		logger.error("error in parsing pixel spacing range", ex);
    	}
    }
}
