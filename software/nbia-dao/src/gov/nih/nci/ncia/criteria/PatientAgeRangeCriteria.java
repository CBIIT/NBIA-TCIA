...
public class PatientAgeRangeCriteria extends PersistentCriteria {
    private static final long serialVersionUID = 1L;
    private String from;
    private String to;
    private static Logger logger = LogManager.getLogger(PatientAgeRangeCriteria.class);
    ...
    public void addValueFromQueryAttribute(QueryAttributeWrapper attr) {
    	...
    	try {
    		...
    		logger.error("error in parsing age range", ex);
    	}
    }
}
