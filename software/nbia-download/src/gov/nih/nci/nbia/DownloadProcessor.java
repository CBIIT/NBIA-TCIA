...
public class DownloadProcessor {
	 ...
	 * @param ssg
	 */
	public boolean hasAccess(String userId, String password, String project, String siteName, String ssg) {
		try {
	...
	private static boolean checkCredentials(String userId, String password) throws Exception {
