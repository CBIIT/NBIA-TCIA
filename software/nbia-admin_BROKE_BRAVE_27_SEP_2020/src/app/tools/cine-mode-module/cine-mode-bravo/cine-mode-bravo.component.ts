...
export class CineModeBravoComponent implements OnInit, OnDestroy{
    ...
    constructor( private cineModeService: CineModeBravoService, private apiService: ApiService, private httpClient: HttpClient,
    ...
    ngOnInit() {
        ...
        this.cineModeService.hideCineModeEmitter.pipe( takeUntil( this.ngUnsubscribe ) ).subscribe(
            ( data ) => {
    ...
    fullCineMode() {
        if( this.fullSize ){
            /*
                        console.log('MHL need to set height to: ', this.divHeight);
                        console.log('MHL need to set width to: ', this.divWidth);
            */
            this.fullSize = false;
            this.divTop = this.divTopHold;
            this.divLeft = this.divLeftHold;
            console.log( 'MHL Full size is false' );
            console.log( 'MHL  set Top to: ', this.divTop );
            console.log( 'MHL  set left to: ', this.divLeft );
        ...
        console.log( 'MHL fullCineMode setting to: ', this.fullSize );
