...
export class SearchResultsSectionBravoComponent implements OnInit, OnDestroy{
    ...
    isMac = typeof navigator !== 'undefined' ? navigator.userAgent.includes( 'Mac OS' ) : false;
    modifiers = {
        shift: 'shiftKey',
        ctrl: 'ctrlKey',
        // alt: 'altKey',
        alt: this.isMac ? 'metaKey' : 'alt',
        cmd: this.isMac ? 'metaKey' : 'ctrlKey',
        command: this.isMac ? 'metaKey' : 'ctrlKey',
        meta: this.isMac ? 'metaKey' : 'ctrlKey',
        'left command': 'metaKey',
        'right command': 'MetaRight',
        '⌘': this.isMac ? 'metaKey' : 'ctrlKey',
        option: 'altKey',
        ctl: 'ctrlKey',
        control: 'ctrlKey'
    };
    ...
    constructor( private apiService: ApiService, private cineModeService: CineModeBravoService,
...
/*
        console.log( 'MHL typeof navigator: ', typeof navigator );
        console.log( 'MHL isMac: ', this.isMac );
        console.log( 'MHL navigator.userAgent: ', navigator.userAgent );
*/
