...
*/
    ...
    initParameters() {
       ...
       // this.criteriaName = this.queryCriteriaData['dynamicQueryCriteria'];
        ...
        console.log('MHL Setting criteriaSingleLineRadio: ', this.criteriaSingleLineRadio);
...
*/
        ...
        if (this.queryCriteriaData['dynamicQueryCriteriaListData'] !== undefined && this.queryCriteriaData['dynamicQueryCriteriaListData']) {
            this.initItemList(this.queryCriteriaData['dynamicQueryCriteriaListData'].split(','));
        }
/*
...
*/
        if (this.queryCriteriaData['dynamicQueryCriteriaAndOrType'] !== undefined) {
        ...
        if (this.queryCriteriaData['dynamicQueryCriteriaAllAnyType'] !== undefined) {
    ...
    initItemList(origList) {
        ...
        console.log('MHL 002 this.criteriaAllowNoChoice: ', this.criteriaAllowNoChoice);
        if (this.criteriaAllowNoChoice) {
    ...
    onCriteriaClicked(i) {
        if (this.criteriaSingleChoiceList) {
            console.log('MHL onCriteriaClicked this.itemList[' + i + ']: ', this.itemList[i]);
            for (let n = 0; n < this.listCheckboxes.length; n++) {
                this.listCheckboxes[n] = false;
            }
            this.listCheckboxes[i] = true;
            this.criteriaHeadingAddOn = this.itemList[i]['value'];
            console.log('MHL onCriteriaClicked criteriaHeadingAddOn: ', this.criteriaHeadingAddOn);
        }
