 ...
 */
@Component( {
    selector: 'nbia-collection-query-builder',
    templateUrl: './collection-query-builder.component.html',
    styleUrls: ['../query-builder.component.scss', './collection-query-builder.component.scss']
} )


export class CollectionQueryBuilderComponent implements OnInit, OnDestroy{
    ...
    constructor( private commonService: CommonService,private commonQueryBuilderService: CommonQueryBuilderService,
                 ...
                 private parameterQBService: ParameterQBSearchService, 
    ...
    async ngOnInit() {
        ...
        this.apiServerService.getCollectionValuesAndCountsEmitter.pipe( takeUntil( this.ngUnsubscribe ) ).subscribe(
            data => {
                ...
                else if( this.apiServerService.getQueryBuilderSearchQueryHold() === null ){
        ...
        this.commonQueryBuilderService.queryBuilderSearchResultsCountEmitter.pipe( takeUntil( this.ngUnsubscribe ) ).subscribe(
            data => {
                if( this.commonService.getResultsDisplayMode() === Consts.QUERY_BUILDER_SEARCH ){
                    // data  0 = No results from a search,  -1 = No search

                    // If a Query Builder Search returned no results
                    if( data === 0 ){
        ...
        this.commonQueryBuilderService.resetAllQueryBuilderSearchForLoginEmitter.pipe( takeUntil( this.ngUnsubscribe ) ).subscribe(
            async() => {
                ...
                if( this.parameterQBService.haveUrlQueryBuilderParameters() ){
        ...
        this.parameterService.parameterCollectionEmitter.pipe( takeUntil( this.ngUnsubscribe ) ).subscribe(
            data => {
                ...
                for( let criteriaQuery of criteriaListQueryList ){
                    ...
                    for( let f = 0; f < this.criteriaList.length; f++ ){
                        if( criteriaQuery.toUpperCase() === this.criteriaList[f].criteria.toUpperCase() ){
                            ...
                            this.commonQueryBuilderService.setHaveUserInput( false );
                        }
                    }
                ...
                if( this.missingCriteria.length > 0 ){
                    ...
                    this.commonQueryBuilderService.updateMissingQueryBuilderCriteriaArray( this.missingCriteria );
                }
        ...
        this.showCriteriaList = this.commonQueryBuilderService.getCriteriaQueryShow( Consts.SHOW_CRITERIA_QUERY_COLLECTIONS );
        if( this.utilService.isNullOrUndefined( this.showCriteriaList ) ){
            ...
            this.commonQueryBuilderService.setCriteriaQueryShow( Consts.SHOW_CRITERIA_QUERY_COLLECTIONS, this.showCriteriaList );
        }
    ...
    async onCriteriaCountsChange( data ) {
        ...
        if( this.apiServerService.getQueryBuilderSearchQueryHold() === null ){
    ...
    onCheckboxClick( i, checked ) {
        ...
        this.commonQueryBuilderService.setHaveUserInput( true );
