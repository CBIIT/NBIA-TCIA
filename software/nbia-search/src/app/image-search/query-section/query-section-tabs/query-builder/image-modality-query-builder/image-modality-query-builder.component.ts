 ...
 */
@Component( {
    selector: 'nbia-image-modality-query-builder',
    templateUrl: './image-modality-query-builder.component.html',
    styleUrls: ['../../../../../app.component.scss', '../query-builder.component.scss']
} )
export class ImageModalityQueryBuilderComponent implements OnInit, OnDestroy{
...
// ------------------------------------------------------------------------------------------
        ...
        this.commonQueryBuilderService.resetAllQueryBuilderSearchForLoginEmitter.pipe( takeUntil( this.ngUnsubscribe ) ).subscribe(
            async() => {
                ...
                if( this.parameterQBSearchService.haveUrlQueryBuilderParameters() ){
        ...
        this.showCriteriaList = this.commonQueryBuilderService.getCriteriaQueryShow( Consts.SHOW_CRITERIA_QUERY_IMAGE_MODALITY );
        if( this.utilService.isNullOrUndefined( this.showCriteriaList ) ){
            ...
            this.commonQueryBuilderService.setCriteriaQueryShow( Consts.SHOW_CRITERIA_QUERY_IMAGE_MODALITY, this.showCriteriaList );
        }
