...
@Component( {
    selector: 'nbia-species-query-builder',
    templateUrl: './species-query-builder.component.html',
    styleUrls: ['../../../../../app.component.scss', '../query-builder.component.scss']
} )
export class SpeciesQueryBuilderComponent implements OnInit, OnDestroy{
    ...
    async ngOnInit() {
        ...
        this.showCriteriaList = this.commonQueryBuilderService.getCriteriaQueryShow( Consts.SHOW_CRITERIA_QUERY_SPECIES );
        if( this.utilService.isNullOrUndefined( this.showCriteriaList ) ){
            ...
            this.commonQueryBuilderService.setCriteriaQueryShow( Consts.SHOW_CRITERIA_QUERY_SPECIES, this.showCriteriaList );
        }
