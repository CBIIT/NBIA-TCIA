...
@Component( {
    selector: 'nbia-display-query-query-builder-search',
    templateUrl: './display-query-query-builder-search.component.html',
...
export class DisplayQueryQueryBuilderComponent implements OnInit, OnDestroy{
    ...
    anyOrAll;
     ...
     /**
     * The data received by updateCriteriaSearchQueryForDisplayEmitter.subscribe.
     *
     * @type {Array}
     */
     criteriaList = [];
    ...
    constructor( private commonService: CommonService , private commonQueryBuilderService: CommonQueryBuilderService,
        ...
        private menuService: MenuService) {
            ...
            this.comQBService = commonQueryBuilderService;
    }
    ...
    */
    ...
    ngOnInit() {
        ...
        this.commonQueryBuilderService.queryBuilderAnyOrAllEmitter.pipe(takeUntil(this.ngUnsubscribe)).subscribe(
            data => {
                this.anyOrAll = data;
            }
        );

        this.anyOrAll = this.commonQueryBuilderService.getQueryBuilderAnyOrAll();
    }
    ...
    async onClearQueryBuilderClick() {
        this.apiServerService.setQueryBuilderSearchQueryHold( null );
        this.commonQueryBuilderService.updateQueryBuilderSearchResultsCount( -1 );
    ...
    onClickQueryBuilderClearQuery() {
        this.commonQueryBuilderService.clearAllQueryBuilder();
        this.data = [];
    }
