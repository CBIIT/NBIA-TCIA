...
@Path("/v4/getCollectionValuesAndCounts")
public class GetCollectionValuesAndCounts extends getData{
  private static final String[] columns={"Collection", "Count", "Authorized"};
  ...
  @Produces({MediaType.APPLICATION_XML, MediaType.APPLICATION_JSON, MediaType.TEXT_HTML, TEXT_CSV})
    ...
    return formatResponse(format, values, columns);
		...
		//return Response.ok(JSONUtil.getJSONforCollectionCounts_v4(values)).type("application/json")
		//		.build();
	}
}
